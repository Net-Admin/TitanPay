...
class Menu:
    ...
    #def initialize(self):
        ...
        self.union_dues_label = tkinter.Label(self.row4, text='Union Dues:')
        self.union_dues_entry = tkinter.Entry(self.row4, width=10)

        self.row5 = tkinter.Frame(self.main_window)
        self.hourly_rate = tkinter.LabelFrame(self.row4, text="     Hourly Rate", bd=0, padx=2)
        self.hourly_rate_entry = tkinter.Entry(self.hourly_rate, width=15)
        self.display_timecards = tkinter.Button(self.row4, text="Display Time Cards", height=2)
        self.salary = tkinter.LabelFrame(self.row4, text="         Salary", bd=0, padx=2)
        self.salary_entry = tkinter.Entry(self.salary, width=15)
        self.display_sales = tkinter.Button(self.row4, text="View Sales", height=2)
